...
How we built the program:
  ...
  Since they return the utility value, we write the method called "Search" to search the best moves and return the columns, which are the places to drop the pieces.
