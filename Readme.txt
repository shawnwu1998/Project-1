...
How to run the program:
  ...
  First, our programm allows the user to choose the board, one is 3*3*3, and the other is 6*7*4;
...
How we built the program:
  ...
  We then constructed RAMDOM method which allows the computer to randomly drop a chess piece on the board. Then we constructed MINIMAX, MINIMAX with alpha beta pruning and H-MINIMAX as the methods the computer uses to drop a piece. Meanwhile, we also constructed a scoring system, which allows the computer to make the optimal move based on the score of each position on the board.
